...
UPDATE EMPLOYEE2
SET SALARY = SALARY + '10000000000000'
...
--핸드폰번호 EMPLOYEE2 에서 010위에 - 붙여서 변경
--LIKE --> 무조건 맨앞이 010이어야하고 중간에오는 010은 변경X
UPDATE EMPLOYEE2
...
--UPDATE EMPLOYEE2 SET HIRE_DATE = REPLACE ( HIRE_DATE, TO_DATE('1999-09-09', 'YYYY-MM-DD'), TO_DATE('2000-01-02' , 'YYYY-MM-DD')   );
