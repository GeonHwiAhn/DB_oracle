...
WHERE E.DEPT_CODE = (SELECT DEPT_CODE FROM EMPLOYEE WHERE DEPT_CODE = '노옹철'
AND J.JOB_CODE = (SELECT JOB_CODE FROM EMPLOYEE WHERE JOB_CODE = '노옹철';
...
--E1이 2000년에 입사한 직원을 기준으로 동일한 부서와 직급을 가진 직원 E2 찾음
