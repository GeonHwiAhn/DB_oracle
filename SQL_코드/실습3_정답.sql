...
VALUES ('223', '김영수', '850101-1234567', 'kim_ys@or.kr', '01012345678', 'D1', 'J4', 'S2', '3500000', '0.1', '200', '15/06/20', null, 'N');
...
-> DEPARTMENT2 테이블에서 "DEPT_ID"에 해당하는 컬럼의 크기를
        2에서 3으로 늘려주거나
        VARCHAR2로 변경해서 255까지 늘려주는 방법이 존재 -> VARCHAR2 알아서 공간크기르 ㄹ조정
...
INSERT INTO EMPLOYEE2
VALUES ('224', '이수진', '900101-2345678', 'lee_sj@or.kr', '01098765432', 'D2', 'J2', 'S3', '3000000', '0.15', '201', '16/07/01', null, 'N');
...
--PHONE = '010-' || SUBSTR (PHONE, 4, 4) || '-' || SUBSTR(PHONE,8);
    --PHONE = REGEXP_REPLACE(PHONE, '(\d{3}) ('\d{4}) (\d{4})', '\1-\d-\3');
...
UPDATE EMPLOYEE2
SET DEPT_CODE = 'D5', BONUS = BONUS + 0.05
WHERE DEPT_CODE = 'D5';
