...
SELECT FLOOR(5.789, 1) FROM DUAL;    --에러 발생, 소수 표현 XXXX

---2) TRUNC : 숫자의 소수점을 잘라내는 역할
------자르고자 하는 자릿수를 작성 지정하지 않으면 기본값 0
...
SELECT '        점           심       ',
            TRIM(LEADING ' ' FROM '        점           심       '),      --양쪽 공백 제거 
            TRIM(TRAILING ' ' FROM '        점           심       '),      --양쪽 공백 제거 
            TRIM(BOTH ' ' FROM '        점           심       ')      --양쪽 공백 제거 
FROM DUAL;
