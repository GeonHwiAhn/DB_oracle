...
--9를 사용하지 않으면 기본으로 왼쪽 정렬 9의 반대는 아무것도 작성하지 않은 것
...
--L의 경우 현재 시스템에서 사용하는 화폐단위 기호, 한국 = \
...
--DUAL 테이블 사용해서 현재 날짜(SYSDATE) 2024-06-05
...
FROM DUAL;                                  --2024년 06월 05일  오전 10시 32분 24초 
