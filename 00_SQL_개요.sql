...
/*
squplus : 오라클 데이터베이스에서 제공하는 명령줄 도구
sys         : 시스템(system) 단축어
...
USER      : 사용자를
아이디명 : 사용자이름
IEDNTIFIED BY : 생성한 사용자계정에 대한 비밀번호를 설정하기 위한 코드
비밀번호 : 비밀번호 설정
*/
...
INSERT INTO MEMBER (M_ID, M_NAME, M_AGE, M_PHONE, M_DATE) VALUES(6, '정수진', '33', '1234567896', '2024-05-06');
...
--KH 카페 추가하기
INSERT INTO kh_cafe (C_ID, C_NAME, C_ADDRESS, C_PHONE, C_TIME) VALUES(1, '메가커피', '서울시 강남구 강남동', '02-888-8888', '영업시간 : 9:00~18:00');
